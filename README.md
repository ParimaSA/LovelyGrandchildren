...
- The mascot’s name and information.
...
3. Connect to Firebase:  
   ...
   In step 4 of the setup guide, add the following Firebase libraries:  
   - `FirebaseCore`
   - `FirebaseDatabase` 
   - `FirebaseFirestore`
   - `FirebaseStorage`
   ...
   After completing the guide, go to your project target in Xcode → **General** tab → scroll to **Frameworks, Libraries, and Embedded Content** and add the same Firebase libraries there as well.
